...
fn main() {
    ...
    let runtime_verus_hashes = verification_lib::extract_verus_hashes_from_str(verus_content)
        .expect("FATAL: Failed to extract runtime Verus specification hashes!");
