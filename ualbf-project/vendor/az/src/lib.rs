...
#![no_std]
#![warn(missing_docs)]
#![doc(html_root_url = "https://docs.rs/az/~1.3")]
...
This trait will be deprecated in version 1.4.0. Use [`StrictCast`] instead.
...
This is a convenience trait to enable writing
<code>src.[strict\_as][`StrictAs::strict_as`]::&lt;Dst&gt;()</code>.
This would not work with the
<code>[StrictCast][`StrictCast`]::[strict\_cast][`StrictCast::strict_cast`]</code>
...
If there is an implementation of
<code>[StrictCast][`StrictCast`]&lt;Dst&gt;</code> for `&Src`
but not for `Src`, and the variable `src` is of type `Src`, then
<code>src.[strict\_as][`StrictAs::strict_as`]::&lt;Dst&gt;()</code>
would not work and
<code>(&src).[strict\_as][`StrictAs::strict_as`]::&lt;Dst&gt;()</code>
is not easy to use with chaining, but
<code>src.[borrow][`borrow`]().[strict\_as][`StrictAs::strict_as`]::&lt;Dst&gt;()</code>
works.
...
assert_eq!(17.1f32.strict_as::<u8>(), 17);
```
...
```rust,should_panic
use az::StrictAs;
let _overflow = (-5i32).strict_as::<u32>();
```
...
let owned = I(12);
assert_eq!(owned.borrow().strict_as::<i64>(), 12);
# }
```
...
///
/// ```rust
/// assert_eq!(az::strict_cast::<i32, u32>(5), 5);
/// assert_eq!(az::strict_cast::<f32, u8>(17.1), 17);
/// ```
///
/// The following panics because of overflow.
///
/// ```rust,should_panic
/// let _overflow = az::strict_cast::<i32, u32>(-5);
/// ```
#[inline]
#[track_caller]
pub fn strict_cast<Src: StrictCast<Dst>, Dst>(src: Src) -> Dst {
    src.strict_cast()
}
...
/// # Planned deprecation
///
/// This function will be deprecated in version 1.4.0. Use [`strict_cast`]
/// instead.
///
/// # Examples
///
